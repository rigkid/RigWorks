...
The 3D sibling of [`rig.geometry.path`](path.md) — same command grammar, `vec3` points. Cubic Bézier data is the `cubicTo` command. Planar contours stay on path; do not put z = 0 on path3d to fake 2D.
