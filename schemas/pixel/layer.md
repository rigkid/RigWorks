...
**Chrome** (`order`, `locked`, tint, label) lives on [`rig.spatial.layer`](../spatial/layer.md) + [`rig.meta.named`](../meta/named.md) on the same entity. Show/hide is [`rig.render.visibility`](../render/visibility.md). Blend and opacity are [`rig.render.blend`](../render/blend.md). Do not duplicate those fields here.
