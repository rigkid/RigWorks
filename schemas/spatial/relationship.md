...
Scene group folders compose [`rig.spatial.group`](group.md) on the parent entity — still use this `parent` field for children. A scene is an unparented [`rig.spatial.vertex`](vertex.md); locators and groups parent to it.
